...
QT_MOC_LITERAL(1, 8, 8), // "sentWord"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 26), // "on_pushButton_play_clicked"
QT_MOC_LITERAL(4, 45, 12) // "getLineWords"

    },
    "FormOne\0sentWord\0\0on_pushButton_play_clicked\0"
    "getLineWords"
};
...
void FormOne::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sentWord((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->on_pushButton_play_clicked(); break;
        case 2: _t->getLineWords((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FormOne::sentWord)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FormOne::sentWord(QString _t1)
{
